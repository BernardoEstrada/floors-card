...
export declare const restoreBackup: (hass: HomeAssistant | undefined, type: HassioBackupDetail["type"], backupSlug: string, backupDetails: HassioPartialBackupCreateParams | HassioFullBackupCreateParams, useSnapshotUrl: boolean) => Promise<void>;
export {};
